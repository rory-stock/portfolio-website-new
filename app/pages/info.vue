...
<template>
  <div class="md:flex">
    <!-- Profile Image -->
    <div class="mx-3 w-fit pt-3 lg:mx-0 lg:pt-4 lg:pl-4">
      <NuxtPicture
        v-if="image"
    ...
    <div
      v-if="info"
      class="px-3 py-3 selection:bg-black selection:text-white md:mx-0 md:py-2 lg:mx-6 lg:pt-6"
    >
      <h2
      ...
      <p
        class="mt-3 font-ghost md:text-lg lg:mt-6 lg:mr-20 lg:text-2xl"
      >
        {{ info.bio }}
      </p>
    </div>
